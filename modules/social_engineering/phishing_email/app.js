    ...
    <body>
      <div class="container">
        ...
        <div class="card">
          ...
          <ul>
            <li><strong>Authority Impersonation:</strong> Pretending to be from IT, HR, or management</li>
            <li><strong>Urgency/Fear:</strong> "Your account will be suspended in 24 hours!"</li>
            <li><strong>Curiosity:</strong> "You've received a secure document"</li>
            <li><strong>Reward:</strong> "You've won a prize! Click to claim"</li>
            <li><strong>Trust Exploitation:</strong> Spoofing known contacts or services</li>
          </ul>
        </div>
...
app.post('/api/check', (req, res) => {
  ...
  if (answer && answer.toLowerCase().includes('phishing')) {
